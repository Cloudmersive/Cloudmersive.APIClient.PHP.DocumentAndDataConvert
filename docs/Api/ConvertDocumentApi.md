...
> \Swagger\Client\Model\AutodetectToJpgResult convertDocumentAutodetectToJpg($input_file, $quality)
...
[**\Swagger\Client\Model\AutodetectToJpgResult**](../Model/AutodetectToJpgResult.md)
...
> \Swagger\Client\Model\AutodetectToPngResult convertDocumentAutodetectToPngArray($input_file)
...
[**\Swagger\Client\Model\AutodetectToPngResult**](../Model/AutodetectToPngResult.md)
...
> string convertDocumentAutodetectToThumbnail($input_file, $max_width, $max_height, $extension)
...
$input_file = "/path/to/file.txt"; // \SplFileObject | Input file to perform the operation on.
$max_width = 56; // int | Optional; Maximum width of the output thumbnail - final image will be as large as possible while less than or equal to this width. Default is 128.
$max_height = 56; // int | Optional; Maximum height of the output thumbnail - final image will be as large as possible while less than or equal to this width. Default is 128.
...
try {
    $result = $apiInstance->convertDocumentAutodetectToThumbnail($input_file, $max_width, $max_height, $extension);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConvertDocumentApi->convertDocumentAutodetectToThumbnail: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> \Swagger\Client\Model\AutodetectToThumbnailsResult convertDocumentAutodetectToThumbnailsAdvanced($input_file, $pages, $max_width, $max_height, $extension)
...
$input_file = "/path/to/file.txt"; // \SplFileObject | Input file to perform the operation on.
$pages = 56; // int | Optional; Specify how many pages of the document will be converted to thumbnails. Default is 1 page.
$max_width = 56; // int | Optional; Maximum width of the output thumbnail - final image will be as large as possible while less than or equal to this width. Default is 128.
$max_height = 56; // int | Optional; Maximum height of the output thumbnail - final image will be as large as possible while less than or equal to this width. Default is 128.
$extension = "extension_example"; // string | Optional; Specify the file extension of the inputFile. This will improve the response time in most cases. Also allows unsupported files without extensions to still return a corresponding generic icon.

try {
    $result = $apiInstance->convertDocumentAutodetectToThumbnailsAdvanced($input_file, $pages, $max_width, $max_height, $extension);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConvertDocumentApi->convertDocumentAutodetectToThumbnailsAdvanced: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\Swagger\Client\Model\AutodetectToThumbnailsResult**](../Model/AutodetectToThumbnailsResult.md)
...
> \Swagger\Client\Model\TextConversionResult convertDocumentDocToTxt($input_file)
...
try {
    ...
    echo 'Exception when calling ConvertDocumentApi->convertDocumentDocToTxt: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> string convertDocumentDocxToDoc($input_file)
...
try {
    ...
    echo 'Exception when calling ConvertDocumentApi->convertDocumentDocxToDoc: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> string convertDocumentDocxToHtml($input_file)
...
> \Swagger\Client\Model\DocxToJpgResult convertDocumentDocxToJpg($input_file, $quality)
...
try {
    $result = $apiInstance->convertDocumentDocxToJpg($input_file, $quality);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConvertDocumentApi->convertDocumentDocxToJpg: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\Swagger\Client\Model\DocxToJpgResult**](../Model/DocxToJpgResult.md)
...
> \Swagger\Client\Model\DocxToPngResult convertDocumentDocxToPng($input_file)
...
[**\Swagger\Client\Model\DocxToPngResult**](../Model/DocxToPngResult.md)
...
> string convertDocumentDocxToRtf($input_file)
...
try {
    ...
    echo 'Exception when calling ConvertDocumentApi->convertDocumentDocxToRtf: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> \Swagger\Client\Model\EmlToHtmlResult convertDocumentEmlToHtml($input_file, $body_only, $include_attachments)
...
[**\Swagger\Client\Model\EmlToHtmlResult**](../Model/EmlToHtmlResult.md)
...
> \Swagger\Client\Model\EmlToJpgResult convertDocumentEmlToJpg($input_file, $quality)
...
try {
    $result = $apiInstance->convertDocumentEmlToJpg($input_file, $quality);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConvertDocumentApi->convertDocumentEmlToJpg: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\Swagger\Client\Model\EmlToJpgResult**](../Model/EmlToJpgResult.md)
...
> string convertDocumentEmlToPdf($input_file, $body_only)
...
try {
    $result = $apiInstance->convertDocumentEmlToPdf($input_file, $body_only);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConvertDocumentApi->convertDocumentEmlToPdf: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> \Swagger\Client\Model\EmlToPngResult convertDocumentEmlToPng($input_file)
...
try {
    $result = $apiInstance->convertDocumentEmlToPng($input_file);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConvertDocumentApi->convertDocumentEmlToPng: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\Swagger\Client\Model\EmlToPngResult**](../Model/EmlToPngResult.md)
...
> string convertDocumentGetFileTypeIcon($file_extension, $icon_size)
...
$icon_size = 56; // int | Optional; The desired width of the icon, preserving its aspect ratio.

try {
    $result = $apiInstance->convertDocumentGetFileTypeIcon($file_extension, $icon_size);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConvertDocumentApi->convertDocumentGetFileTypeIcon: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> \Swagger\Client\Model\GetFileTypeIconResult convertDocumentGetFileTypeIconAdvanced($file_extension, $icon_size)
...
try {
    $result = $apiInstance->convertDocumentGetFileTypeIconAdvanced($file_extension, $icon_size);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConvertDocumentApi->convertDocumentGetFileTypeIconAdvanced: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\Swagger\Client\Model\GetFileTypeIconResult**](../Model/GetFileTypeIconResult.md)
...
> \Swagger\Client\Model\PdfToPngResult convertDocumentHtmlToPng($input_file)
...
> \Swagger\Client\Model\TextConversionResult convertDocumentHtmlToTxt($input_file)
...
try {
    ...
    echo 'Exception when calling ConvertDocumentApi->convertDocumentHtmlToTxt: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> \Swagger\Client\Model\KeynoteToJpgResult convertDocumentKeynoteToJpg($input_file, $quality)
...
try {
    $result = $apiInstance->convertDocumentKeynoteToJpg($input_file, $quality);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConvertDocumentApi->convertDocumentKeynoteToJpg: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\Swagger\Client\Model\KeynoteToJpgResult**](../Model/KeynoteToJpgResult.md)
...
> string convertDocumentKeynoteToPdf($input_file)
...
try {
    $result = $apiInstance->convertDocumentKeynoteToPdf($input_file);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConvertDocumentApi->convertDocumentKeynoteToPdf: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> \Swagger\Client\Model\KeynoteToPngResult convertDocumentKeynoteToPng($input_file)
...
try {
    $result = $apiInstance->convertDocumentKeynoteToPng($input_file);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConvertDocumentApi->convertDocumentKeynoteToPng: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\Swagger\Client\Model\KeynoteToPngResult**](../Model/KeynoteToPngResult.md)
...
> string convertDocumentKeynoteToPptx($input_file)
...
try {
    $result = $apiInstance->convertDocumentKeynoteToPptx($input_file);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConvertDocumentApi->convertDocumentKeynoteToPptx: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> \Swagger\Client\Model\MsgToHtmlResult convertDocumentMsgToHtml($input_file, $body_only, $include_attachments)
...
[**\Swagger\Client\Model\MsgToHtmlResult**](../Model/MsgToHtmlResult.md)
...
> \Swagger\Client\Model\MsgToJpgResult convertDocumentMsgToJpg($input_file, $quality)
...
try {
    $result = $apiInstance->convertDocumentMsgToJpg($input_file, $quality);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConvertDocumentApi->convertDocumentMsgToJpg: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\Swagger\Client\Model\MsgToJpgResult**](../Model/MsgToJpgResult.md)
...
> string convertDocumentMsgToPdf($input_file, $body_only)
...
try {
    $result = $apiInstance->convertDocumentMsgToPdf($input_file, $body_only);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConvertDocumentApi->convertDocumentMsgToPdf: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> \Swagger\Client\Model\MsgToPngResult convertDocumentMsgToPng($input_file)
...
try {
    $result = $apiInstance->convertDocumentMsgToPng($input_file);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConvertDocumentApi->convertDocumentMsgToPng: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\Swagger\Client\Model\MsgToPngResult**](../Model/MsgToPngResult.md)
...
> \Swagger\Client\Model\OdpToJpgResult convertDocumentOdpToJpg($input_file, $quality)
...
try {
    $result = $apiInstance->convertDocumentOdpToJpg($input_file, $quality);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConvertDocumentApi->convertDocumentOdpToJpg: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\Swagger\Client\Model\OdpToJpgResult**](../Model/OdpToJpgResult.md)
...
> string convertDocumentOdpToPdf($input_file)
...
try {
    $result = $apiInstance->convertDocumentOdpToPdf($input_file);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConvertDocumentApi->convertDocumentOdpToPdf: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> \Swagger\Client\Model\OdpToPngResult convertDocumentOdpToPng($input_file)
...
try {
    $result = $apiInstance->convertDocumentOdpToPng($input_file);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConvertDocumentApi->convertDocumentOdpToPng: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\Swagger\Client\Model\OdpToPngResult**](../Model/OdpToPngResult.md)
...
> string convertDocumentOdpToPptx($input_file)
...
try {
    $result = $apiInstance->convertDocumentOdpToPptx($input_file);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConvertDocumentApi->convertDocumentOdpToPptx: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> \Swagger\Client\Model\OdsToJpgResult convertDocumentOdsToJpg($input_file, $quality)
...
try {
    $result = $apiInstance->convertDocumentOdsToJpg($input_file, $quality);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConvertDocumentApi->convertDocumentOdsToJpg: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\Swagger\Client\Model\OdsToJpgResult**](../Model/OdsToJpgResult.md)
...
> string convertDocumentOdsToPdf($input_file)
...
try {
    $result = $apiInstance->convertDocumentOdsToPdf($input_file);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConvertDocumentApi->convertDocumentOdsToPdf: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> \Swagger\Client\Model\OdsToPngResult convertDocumentOdsToPng($input_file)
...
try {
    $result = $apiInstance->convertDocumentOdsToPng($input_file);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConvertDocumentApi->convertDocumentOdsToPng: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\Swagger\Client\Model\OdsToPngResult**](../Model/OdsToPngResult.md)
...
> string convertDocumentOdsToXlsx($input_file)
...
try {
    $result = $apiInstance->convertDocumentOdsToXlsx($input_file);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConvertDocumentApi->convertDocumentOdsToXlsx: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> string convertDocumentOdtToDocx($input_file)
...
try {
    $result = $apiInstance->convertDocumentOdtToDocx($input_file);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConvertDocumentApi->convertDocumentOdtToDocx: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> \Swagger\Client\Model\OdtToJpgResult convertDocumentOdtToJpg($input_file, $quality)
...
try {
    $result = $apiInstance->convertDocumentOdtToJpg($input_file, $quality);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConvertDocumentApi->convertDocumentOdtToJpg: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\Swagger\Client\Model\OdtToJpgResult**](../Model/OdtToJpgResult.md)
...
> string convertDocumentOdtToPdf($input_file)
...
try {
    $result = $apiInstance->convertDocumentOdtToPdf($input_file);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConvertDocumentApi->convertDocumentOdtToPdf: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> \Swagger\Client\Model\OdtToPngResult convertDocumentOdtToPng($input_file)
...
try {
    $result = $apiInstance->convertDocumentOdtToPng($input_file);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConvertDocumentApi->convertDocumentOdtToPng: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\Swagger\Client\Model\OdtToPngResult**](../Model/OdtToPngResult.md)
...
> string convertDocumentPdfToDocxRasterize($input_file)
...
try {
    $result = $apiInstance->convertDocumentPdfToDocxRasterize($input_file);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConvertDocumentApi->convertDocumentPdfToDocxRasterize: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> \Swagger\Client\Model\PdfToJpgResult convertDocumentPdfToJpg($input_file, $quality)
...
try {
    $result = $apiInstance->convertDocumentPdfToJpg($input_file, $quality);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConvertDocumentApi->convertDocumentPdfToJpg: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\Swagger\Client\Model\PdfToJpgResult**](../Model/PdfToJpgResult.md)
...
[**\Swagger\Client\Model\PdfToPngDirectResult**](../Model/PdfToPngDirectResult.md)
...
> string convertDocumentPdfToPngSingle($input_file)
...
try {
    $result = $apiInstance->convertDocumentPdfToPngSingle($input_file);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConvertDocumentApi->convertDocumentPdfToPngSingle: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    $result = $apiInstance->convertDocumentPngArrayToPdfFlattenTransparency();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConvertDocumentApi->convertDocumentPngArrayToPdfFlattenTransparency: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> \Swagger\Client\Model\PptxToPngResult convertDocumentPptxToPng($input_file)
...
[**\Swagger\Client\Model\PptxToPngResult**](../Model/PptxToPngResult.md)
...
> \Swagger\Client\Model\TextConversionResult convertDocumentPptxToTxt($input_file)
...
try {
    $result = $apiInstance->convertDocumentPptxToTxt($input_file);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConvertDocumentApi->convertDocumentPptxToTxt: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> string convertDocumentRtfToDocx($input_file)
...
try {
    $result = $apiInstance->convertDocumentRtfToDocx($input_file);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConvertDocumentApi->convertDocumentRtfToDocx: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> string convertDocumentRtfToHtml($input_file)
...
try {
    $result = $apiInstance->convertDocumentRtfToHtml($input_file);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConvertDocumentApi->convertDocumentRtfToHtml: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> \Swagger\Client\Model\RtfToJpgResult convertDocumentRtfToJpg($input_file, $quality)
...
[**\Swagger\Client\Model\RtfToJpgResult**](../Model/RtfToJpgResult.md)
...
> string convertDocumentRtfToPdf($input_file)
...
try {
    $result = $apiInstance->convertDocumentRtfToPdf($input_file);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConvertDocumentApi->convertDocumentRtfToPdf: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> \Swagger\Client\Model\RtfToPngResult convertDocumentRtfToPng($input_file)
...
try {
    $result = $apiInstance->convertDocumentRtfToPng($input_file);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConvertDocumentApi->convertDocumentRtfToPng: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\Swagger\Client\Model\RtfToPngResult**](../Model/RtfToPngResult.md)
...
> string convertDocumentTxtToPdf($input_file, $scale_factor)
...
try {
    $result = $apiInstance->convertDocumentTxtToPdf($input_file, $scale_factor);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConvertDocumentApi->convertDocumentTxtToPdf: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> string convertDocumentXlsToCsv($input_file)
...
try {
    ...
    echo 'Exception when calling ConvertDocumentApi->convertDocumentXlsToCsv: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> \Swagger\Client\Model\XlsxToPngResult convertDocumentXlsxToPng($input_file)
...
try {
    ...
    echo 'Exception when calling ConvertDocumentApi->convertDocumentXlsxToPng: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\Swagger\Client\Model\XlsxToPngResult**](../Model/XlsxToPngResult.md)
...
> \Swagger\Client\Model\TextConversionResult convertDocumentXlsxToTxt($input_file)
...
try {
    ...
    echo 'Exception when calling ConvertDocumentApi->convertDocumentXlsxToTxt: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> string convertDocumentXlsxToXls($input_file)
...
try {
    ...
    echo 'Exception when calling ConvertDocumentApi->convertDocumentXlsxToXls: ', $e->getMessage(), PHP_EOL;
}
?>
```
