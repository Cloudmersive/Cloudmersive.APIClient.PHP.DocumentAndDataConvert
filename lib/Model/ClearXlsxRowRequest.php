...
/**
 * ClearXlsxRowRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ClearXlsxRowRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ClearXlsxRowRequest';
    ...
    protected static $swaggerTypes = [
        ...
        'worksheet_to_edit' => '\Swagger\Client\Model\XlsxWorksheet',
        'row_index' => 'int'
    ];
    ...
    protected static $attributeMap = [
        ...
        'worksheet_to_edit' => 'WorksheetToEdit',
        'row_index' => 'RowIndex'
    ];
    ...
    protected static $setters = [
        ...
        'worksheet_to_edit' => 'setWorksheetToEdit',
    ...
    protected static $getters = [
        ...
        'worksheet_to_edit' => 'getWorksheetToEdit',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['worksheet_to_edit'] = isset($data['worksheet_to_edit']) ? $data['worksheet_to_edit'] : null;
    ...
    public function setInputFileBytes($input_file_bytes)
    {
        ...
        if (!is_null($input_file_bytes) && (!preg_match("/^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/", $input_file_bytes))) {
            throw new \InvalidArgumentException("invalid value for $input_file_bytes when calling ClearXlsxRowRequest., must conform to the pattern /^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/.");
        }
    ...
    /**
     * Gets worksheet_to_edit
     *
     * @return \Swagger\Client\Model\XlsxWorksheet
     */
    public function getWorksheetToEdit()
    {
        return $this->container['worksheet_to_edit'];
    }

    /**
     * Sets worksheet_to_edit
     *
     * @param \Swagger\Client\Model\XlsxWorksheet $worksheet_to_edit Optional; Worksheet (tab) within the spreadsheet to get the specific row from; leave blank to default to the first worksheet
     *
     * @return $this
     */
    public function setWorksheetToEdit($worksheet_to_edit)
    {
        $this->container['worksheet_to_edit'] = $worksheet_to_edit;
     ...
     * Sets row_index
     *
     * @param int $row_index Required; Index for the desired row to be cleared
     *
     * @return $this
     */
