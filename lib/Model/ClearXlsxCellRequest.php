...
/**
 * ClearXlsxCellRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ClearXlsxCellRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ClearXlsxCellRequest';
    ...
    public function setInputFileBytes($input_file_bytes)
    {
        ...
        if (!is_null($input_file_bytes) && (!preg_match("/^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/", $input_file_bytes))) {
            throw new \InvalidArgumentException("invalid value for $input_file_bytes when calling ClearXlsxCellRequest., must conform to the pattern /^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/.");
        }
     ...
     * Sets row_index
     *
     * @param int $row_index 0-based index of the row, 0, 1, 2, ... to clear
     *
     * @return $this
     */
     ...
     * Sets cell_index
     *
     * @param int $cell_index 0-based index of the cell, 0, 1, 2, ... in the row to clear
     *
     * @return $this
     */
