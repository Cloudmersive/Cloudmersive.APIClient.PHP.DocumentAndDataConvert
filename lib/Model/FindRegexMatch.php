...
/**
 * FindRegexMatch Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class FindRegexMatch implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FindRegexMatch';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['match_value'] = isset($data['match_value']) ? $data['match_value'] : null;
        $this->container['match_groups'] = isset($data['match_groups']) ? $data['match_groups'] : null;
    }
     ...
     * Sets match_value
     *
     * @param string $match_value The match value
     *
     * @return $this
     */
    ...
    {
        return $this->container['match_groups'];
    }

    /**
     * Sets match_groups
     *
     * @param string[] $match_groups Regular expression regex match groups; these correspond to the match values
     *
     * @return $this
     */
    public function setMatchGroups($match_groups)
    {
        $this->container['match_groups'] = $match_groups;
