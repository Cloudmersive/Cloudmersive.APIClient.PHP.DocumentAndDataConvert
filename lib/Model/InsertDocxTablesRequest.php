...
/**
 * InsertDocxTablesRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InsertDocxTablesRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'InsertDocxTablesRequest';
    ...
    public function setInputFileBytes($input_file_bytes)
    {
        ...
        if (!is_null($input_file_bytes) && (!preg_match("/^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/", $input_file_bytes))) {
            throw new \InvalidArgumentException("invalid value for $input_file_bytes when calling InsertDocxTablesRequest., must conform to the pattern /^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/.");
        }
    ...
    /**
     * Gets table_to_insert
     *
     * @return \Swagger\Client\Model\DocxTable
     */
    public function getTableToInsert()
    {
        return $this->container['table_to_insert'];
    }

    /**
     * Sets table_to_insert
     *
     * @param \Swagger\Client\Model\DocxTable $table_to_insert Table you would like to insert
     *
     * @return $this
     */
