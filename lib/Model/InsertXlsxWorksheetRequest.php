 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InsertXlsxWorksheetRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'InsertXlsxWorksheetRequest';
    ...
    protected static $swaggerTypes = [
        ...
        'worksheet_to_insert' => '\Swagger\Client\Model\XlsxWorksheet'
    ];
    ...
    protected static $setters = [
        ...
        'worksheet_to_insert' => 'setWorksheetToInsert'
    ];
    ...
    protected static $getters = [
        ...
        'worksheet_to_insert' => 'getWorksheetToInsert'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['worksheet_to_insert'] = isset($data['worksheet_to_insert']) ? $data['worksheet_to_insert'] : null;
    }
    ...
    public function setInputFileBytes($input_file_bytes)
    {
        ...
        if (!is_null($input_file_bytes) && (!preg_match("/^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/", $input_file_bytes))) {
            throw new \InvalidArgumentException("invalid value for $input_file_bytes when calling InsertXlsxWorksheetRequest., must conform to the pattern /^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/.");
        }
    ...
    /**
     * Gets worksheet_to_insert
     *
     * @return \Swagger\Client\Model\XlsxWorksheet
     */
    public function getWorksheetToInsert()
    {
        return $this->container['worksheet_to_insert'];
    }

    /**
     * Sets worksheet_to_insert
     *
     * @param \Swagger\Client\Model\XlsxWorksheet $worksheet_to_insert Workersheet to insert
     *
     * @return $this
     */
    public function setWorksheetToInsert($worksheet_to_insert)
    {
        $this->container['worksheet_to_insert'] = $worksheet_to_insert;
