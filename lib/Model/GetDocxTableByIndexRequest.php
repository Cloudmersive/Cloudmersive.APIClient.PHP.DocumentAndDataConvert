...
/**
 * GetDocxTableByIndexRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GetDocxTableByIndexRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GetDocxTableByIndexRequest';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['table_index'] = isset($data['table_index']) ? $data['table_index'] : null;
    }
    ...
    public function setInputFileBytes($input_file_bytes)
    {
        ...
        if (!is_null($input_file_bytes) && (!preg_match("/^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/", $input_file_bytes))) {
            throw new \InvalidArgumentException("invalid value for $input_file_bytes when calling GetDocxTableByIndexRequest., must conform to the pattern /^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/.");
        }
    ...
    {
        return $this->container['table_index'];
    }

    /**
     * Sets table_index
     *
     * @param int $table_index 0-based index of the table to retrieve from the Word Document
     *
     * @return $this
     */
    public function setTableIndex($table_index)
    {
        $this->container['table_index'] = $table_index;
