...
/**
 * CreateSpreadsheetFromDataRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CreateSpreadsheetFromDataRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateSpreadsheetFromDataRequest';
     ...
     * Sets worksheet_name
     *
     * @param string $worksheet_name Optional; The new Spreadsheet will have a default Worksheet in it; supply a name, or if left empty, will default to Worksheet1
     *
     * @return $this
     */
     ...
     * Sets rows
     *
     * @param \Swagger\Client\Model\XlsxSpreadsheetRow[] $rows Required; Rows and cells to populate the spreadsheet with
     *
     * @return $this
     */
