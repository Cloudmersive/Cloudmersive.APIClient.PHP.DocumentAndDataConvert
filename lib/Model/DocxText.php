 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DocxText implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DocxText';
     ...
     * Sets text_index
     *
     * @param int $text_index Index of the text content in the run; 0-based
     *
     * @return $this
     */
     ...
     * Sets text_content
     *
     * @param string $text_content Text string containing the text content of this text content item
     *
     * @return $this
     */
