...
/**
 * DocxInsertCommentOnParagraphRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DocxInsertCommentOnParagraphRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DocxInsertCommentOnParagraphRequest';
    ...
    protected static $swaggerTypes = [
        ...
        'comment_to_insert' => '\Swagger\Client\Model\DocxComment'
    ];
    ...
    protected static $setters = [
        ...
        'paragraph_path' => 'setParagraphPath',
        'comment_to_insert' => 'setCommentToInsert'
    ];
    ...
    protected static $getters = [
        ...
        'paragraph_path' => 'getParagraphPath',
        'comment_to_insert' => 'getCommentToInsert'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['paragraph_path'] = isset($data['paragraph_path']) ? $data['paragraph_path'] : null;
        $this->container['comment_to_insert'] = isset($data['comment_to_insert']) ? $data['comment_to_insert'] : null;
    }
    ...
    public function setInputFileBytes($input_file_bytes)
    {
        ...
        if (!is_null($input_file_bytes) && (!preg_match("/^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/", $input_file_bytes))) {
            throw new \InvalidArgumentException("invalid value for $input_file_bytes when calling DocxInsertCommentOnParagraphRequest., must conform to the pattern /^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/.");
        }
     ...
     * @return string
     */
    public function getParagraphPath()
    {
        return $this->container['paragraph_path'];
    }

    /**
     * Sets paragraph_path
     *
     * @param string $paragraph_path Path to the paragraph to attach the comment to.  You can get the Path by retrieving all of the Paragraphs in document by calling Get Body and taking the Path property of the desired paragraph to add the comment to.
     *
     * @return $this
     */
    public function setParagraphPath($paragraph_path)
    {
        $this->container['paragraph_path'] = $paragraph_path;

        return $this;
    }

    /**
     * Gets comment_to_insert
     *
     * @return \Swagger\Client\Model\DocxComment
     */
    public function getCommentToInsert()
    {
        return $this->container['comment_to_insert'];
    }

    /**
     * Sets comment_to_insert
     *
     * @param \Swagger\Client\Model\DocxComment $comment_to_insert Comment to insert
     *
     * @return $this
     */
    public function setCommentToInsert($comment_to_insert)
    {
        $this->container['comment_to_insert'] = $comment_to_insert;
