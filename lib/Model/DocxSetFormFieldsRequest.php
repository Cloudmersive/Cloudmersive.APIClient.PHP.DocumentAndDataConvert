...
/**
 * DocxSetFormFieldsRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DocxSetFormFieldsRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DocxSetFormFieldsRequest';
    ...
    protected static $swaggerTypes = [
        ...
        'handlebar_fields_to_fill' => '\Swagger\Client\Model\FillHandlebarFormField[]'
    ];
    ...
    protected static $setters = [
        ...
        'handlebar_fields_to_fill' => 'setHandlebarFieldsToFill'
    ];
    ...
    protected static $getters = [
        ...
        'handlebar_fields_to_fill' => 'getHandlebarFieldsToFill'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['handlebar_fields_to_fill'] = isset($data['handlebar_fields_to_fill']) ? $data['handlebar_fields_to_fill'] : null;
    }
    ...
    public function setInputFileBytes($input_file_bytes)
    {
        ...
        if (!is_null($input_file_bytes) && (!preg_match("/^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/", $input_file_bytes))) {
            throw new \InvalidArgumentException("invalid value for $input_file_bytes when calling DocxSetFormFieldsRequest., must conform to the pattern /^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/.");
        }
    ...
    /**
     * Gets handlebar_fields_to_fill
     *
     * @return \Swagger\Client\Model\FillHandlebarFormField[]
     */
    public function getHandlebarFieldsToFill()
    {
        return $this->container['handlebar_fields_to_fill'];
    }

    /**
     * Sets handlebar_fields_to_fill
     *
     * @param \Swagger\Client\Model\FillHandlebarFormField[] $handlebar_fields_to_fill Handlebar style form fields to fill in; form field that is handlebar style, such as \"{{FieldName}}\"
     *
     * @return $this
     */
    public function setHandlebarFieldsToFill($handlebar_fields_to_fill)
    {
        $this->container['handlebar_fields_to_fill'] = $handlebar_fields_to_fill;
