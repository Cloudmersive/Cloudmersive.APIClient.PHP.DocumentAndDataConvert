...
/**
 * DocxSetHeaderRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DocxSetHeaderRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DocxSetHeaderRequest';
    ...
    protected static $swaggerTypes = [
        ...
        'header_to_apply' => '\Swagger\Client\Model\DocxHeader'
    ];
    ...
    protected static $setters = [
        ...
        'header_to_apply' => 'setHeaderToApply'
    ];
    ...
    protected static $getters = [
        ...
        'header_to_apply' => 'getHeaderToApply'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['header_to_apply'] = isset($data['header_to_apply']) ? $data['header_to_apply'] : null;
    }
    ...
    public function setInputFileBytes($input_file_bytes)
    {
        ...
        if (!is_null($input_file_bytes) && (!preg_match("/^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/", $input_file_bytes))) {
            throw new \InvalidArgumentException("invalid value for $input_file_bytes when calling DocxSetHeaderRequest., must conform to the pattern /^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/.");
        }
    ...
    /**
     * Gets header_to_apply
     *
     * @return \Swagger\Client\Model\DocxHeader
     */
    public function getHeaderToApply()
    {
        return $this->container['header_to_apply'];
    }

    /**
     * Sets header_to_apply
     *
     * @param \Swagger\Client\Model\DocxHeader $header_to_apply Header to apply
     *
     * @return $this
     */
    public function setHeaderToApply($header_to_apply)
    {
        $this->container['header_to_apply'] = $header_to_apply;
