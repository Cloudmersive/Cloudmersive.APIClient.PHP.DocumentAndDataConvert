...
/**
 * AppendXlsxRowRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AppendXlsxRowRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AppendXlsxRowRequest';
    ...
    protected static $swaggerTypes = [
        ...
        'row' => '\Swagger\Client\Model\XlsxSpreadsheetRow'
    ];
    ...
    public function setInputFileBytes($input_file_bytes)
    {
        ...
        if (!is_null($input_file_bytes) && (!preg_match("/^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/", $input_file_bytes))) {
            throw new \InvalidArgumentException("invalid value for $input_file_bytes when calling AppendXlsxRowRequest., must conform to the pattern /^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/.");
        }
     ...
     *
     * @param \Swagger\Client\Model\XlsxWorksheet $worksheet_to_update Optional; Worksheet (tab) within the spreadsheet to get the specific row from; leave blank to default to the first worksheet
     *
     * @return $this
     */
     ...
     * Sets row
     *
     * @param \Swagger\Client\Model\XlsxSpreadsheetRow $row Required; Row to be appended to the worksheet.
     *
     * @return $this
     */
