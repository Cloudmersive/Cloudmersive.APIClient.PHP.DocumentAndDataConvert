...
/**
 * RemoveXlsxWorksheetRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RemoveXlsxWorksheetRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RemoveXlsxWorksheetRequest';
    ...
    protected static $swaggerTypes = [
        ...
        'worksheet_to_remove' => '\Swagger\Client\Model\XlsxWorksheet'
    ];
    ...
    protected static $attributeMap = [
        ...
        'worksheet_to_remove' => 'WorksheetToRemove'
    ];
    ...
    protected static $setters = [
        ...
        'worksheet_to_remove' => 'setWorksheetToRemove'
    ];
    ...
    protected static $getters = [
        ...
        'worksheet_to_remove' => 'getWorksheetToRemove'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['worksheet_to_remove'] = isset($data['worksheet_to_remove']) ? $data['worksheet_to_remove'] : null;
    }
    ...
    public function setInputFileBytes($input_file_bytes)
    {
        ...
        if (!is_null($input_file_bytes) && (!preg_match("/^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/", $input_file_bytes))) {
            throw new \InvalidArgumentException("invalid value for $input_file_bytes when calling RemoveXlsxWorksheetRequest., must conform to the pattern /^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/.");
        }
    ...
    /**
     * Gets worksheet_to_remove
     *
     * @return \Swagger\Client\Model\XlsxWorksheet
     */
    public function getWorksheetToRemove()
    {
        return $this->container['worksheet_to_remove'];
    }

    /**
     * Sets worksheet_to_remove
     *
     * @param \Swagger\Client\Model\XlsxWorksheet $worksheet_to_remove Required; Worksheet (tab) within the spreadsheet to delete; leave blank to default to the first worksheet.  Use the Get Worksheets API to enumerate available worksheets in a spreadsheet.
     *
     * @return $this
     */
    public function setWorksheetToRemove($worksheet_to_remove)
    {
        $this->container['worksheet_to_remove'] = $worksheet_to_remove;
