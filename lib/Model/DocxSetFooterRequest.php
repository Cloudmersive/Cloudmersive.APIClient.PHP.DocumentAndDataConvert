...
/**
 * DocxSetFooterRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DocxSetFooterRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DocxSetFooterRequest';
    ...
    protected static $swaggerTypes = [
        ...
        'footer_to_apply' => '\Swagger\Client\Model\DocxFooter'
    ];
    ...
    protected static $setters = [
        ...
        'footer_to_apply' => 'setFooterToApply'
    ];
    ...
    protected static $getters = [
        ...
        'footer_to_apply' => 'getFooterToApply'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['footer_to_apply'] = isset($data['footer_to_apply']) ? $data['footer_to_apply'] : null;
    }
    ...
    public function setInputFileBytes($input_file_bytes)
    {
        ...
        if (!is_null($input_file_bytes) && (!preg_match("/^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/", $input_file_bytes))) {
            throw new \InvalidArgumentException("invalid value for $input_file_bytes when calling DocxSetFooterRequest., must conform to the pattern /^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/.");
        }
    ...
    /**
     * Gets footer_to_apply
     *
     * @return \Swagger\Client\Model\DocxFooter
     */
    public function getFooterToApply()
    {
        return $this->container['footer_to_apply'];
    }

    /**
     * Sets footer_to_apply
     *
     * @param \Swagger\Client\Model\DocxFooter $footer_to_apply Footer to apply
     *
     * @return $this
     */
    public function setFooterToApply($footer_to_apply)
    {
        $this->container['footer_to_apply'] = $footer_to_apply;
