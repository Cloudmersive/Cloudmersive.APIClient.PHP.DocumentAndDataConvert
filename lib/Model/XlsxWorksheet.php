...
/**
 * XlsxWorksheet Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class XlsxWorksheet implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'XlsxWorksheet';
     ...
     * Sets path
     *
     * @param string $path The Path of the location of this object; leave blank for new worksheets
     *
     * @return $this
     */
     ...
     * Sets worksheet_name
     *
     * @param string $worksheet_name User-facing name of the worksheet tab
     *
     * @return $this
     */
